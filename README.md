...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/m2r-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/m2r-feedstock)
...
Once the `conda-forge` channel has been enabled, `m2r` can be installed with:

```
conda install m2r
```

It is possible to list all of the versions of `m2r` available on your platform with:
